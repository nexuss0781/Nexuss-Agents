    ...
    <div className="app-shell">
      <aside className={`sidebar ${mobileNav ? "sidebar-open" : ""}`}>
        <div className="brand-row">
          ...
          <div><div className="brand-name">NEXUSS-AGENT</div><div className="brand-meta">PRIVATE CONSOLE <span>LOCAL</span></div></div>
        ...
        <div className="sidebar-section thread-section">
          <div className="section-label"><span>History</span><span className="count">{workspace.threads.length.toString().padStart(2, "0")}</span></div>
