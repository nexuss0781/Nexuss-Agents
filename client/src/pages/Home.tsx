  ...
  return (
    <div className="app-shell">
      <aside className={`sidebar ${mobileNav ? "sidebar-open" : ""}`}>
        ...
        <div className="sidebar-footer"><div className="profile-row"><div className="profile-avatar">NA</div><div className="profile-copy"><strong>Nexuss Operator</strong></div><MoreHorizontal size={15} /></div></div>
      </aside>

      <main className="main-stage">
        <header className="topbar"><div className="topbar-left"><button className="icon-button mobile-menu" onClick={() => setMobileNav(true)} aria-label="Open navigation"><Menu size={19} /></button><div className="topbar-thread-title">{activeThread?.title || "New thread"}</div></div><div className="topbar-right"><div className="avatar">NA</div></div></header>
